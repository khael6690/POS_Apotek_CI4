    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="<?= base_url('obat-create') ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        <?= csrf_field() ?>
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Obat</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= $validation->hasError('nama') ? 'is-invalid' : '' ?> >" id="nama" name="nama" value="<?= old('nama') ?>" placeholder="Nama Obat">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input <?= $validation->hasError('img') ? 'is-invalid' : '' ?>" name="img" value="<?= old('img') ?>" id="img" onchange="previewImage()" accept="image/*">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control <?= $validation->hasError('stok') ? 'is-invalid' : '' ?> >" id="stok" name="stok" value="<?= old('stok') ?>" placeholder="Stok Obat">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="invalid-feedback">
                                        <span><?= $validation->getError('produsen'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control <?= $validation->hasError('harga') ? 'is-invalid' : '' ?> >" id="harga" name="harga" value="<?= old('harga') ?>" placeholder="1000">
                                        <div class="invalid-feedback">
